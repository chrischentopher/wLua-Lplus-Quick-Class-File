_G.LUA_PATH =  'G:\\svn\\phecda_client\\trunk\\Azure\\Output\\Lua'
...
if not _G.LplusFactoryData then
	if _G.LplusFactoryIsOuter then --外部版不能用reload
		_G.CT_FILE_PATH = 'G:\\svn\\phecda_client\\trunk\\private\\RunGamePck\\More\\LplusFactory'
		...
		_G.CT_FILE_PATH = _G.LUA_PATH..'\\LplusFactory'
